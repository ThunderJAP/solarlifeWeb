                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        ...
                        <div className="my-2 w-1/2 lg:w-2/4">
                            <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-gray-500 hover:bg-green-600 text-gray-100 p-3 rounded-lg w-full 
                        ...
                        <div
                            className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-green-800 rounded-2xl">
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-100">XXXXXXXXX</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-100">Tel: 00000000000</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">Send an E-mail</h2>
                                <p className="text-gray-100">XXXXXXXXXXXXXXXXX</p>
                            </div>
