...
import img from '../images/serviceImg1.png';
        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                <div className="my-4 py-4">
                    <h2 className="my-2 text-center text-3xl text-green-600 uppercase font-bold">we provides</h2>

                    <div className='flex justify-center'>
                        <div className='w-24 border-b-4 border-grey-700'></div>
                    </div>
                ...
                <div className="px-12" data-aos="fade-down" data-aos-delay="600">
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-green-700 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                                ...
                                <h2 className="font-semibold my-4 text-2xl text-center">Latest Technology</h2>
                                <p className="text-md font-medium">
                                "Our products are built with the latest technology, ensuring top performance, reliability, and a future-ready experience you can trust."
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-green-700 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                                ...
                                <h2 className="font-semibold my-4 text-2xl text-center">Customer Support</h2>
                                <p className="text-md font-medium">
                                "We provide 24/7 customer support, ensuring you're always covered with expert assistance whenever you need it, day or night."
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-green-700 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                                ...
                                <h2 className="font-semibold my-4 text-2xl text-center ">Save Your Money</h2>
                                <p className="text-md font-medium">
                                "Our products are designed to help you save money, offering high value, efficiency, and long-term savings without compromising on quality."
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-green-700 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                                ...
                                <h2 className="font-semibold my-4 text-2xl text-center ">Eco-Friendly</h2>
                                <p className="text-md font-medium">
                                "Our products are eco-friendly, crafted with sustainability in mind to reduce environmental impact while delivering top-tier performance."
                                </p>
                            </div>
                        </div>
                    </div>
