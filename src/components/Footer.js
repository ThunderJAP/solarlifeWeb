                    ...
                    <div className="grid sm:grid-cols-12 gap-5 py-8 md:py-12 border-t border-gray-200 lg:ml-11">
                        ...
                        <div className="col-span-12 lg:col-span-4">
                            <div className="box-border border-b-4 border-green-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                                <h3 className="font-bold text-4xl mb-4">Find Us</h3>
                                <div className='text-md font-medium text-gray-600'>
                                    <h5>Solar Life Technologies (Pvt) Ltd, </h5>
                                    <p> 5/2, Highlevel Road Panagoda,</p>
                                    <p>Godagama,</p>
                                    <p>Homagama 12200.</p>
                                </div>
                                {/* Google Map */}
                                <div className="mt-4">
                                    <iframe
                                        title="Solar Life Location"
                                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.3153927191706!2d80.03391357524376!3d6.85274689314563!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2524933aa3455%3A0x60c986f821d17267!2sSolar%20Life%20Technologies%20(Pvt)%20Ltd!5e0!3m2!1sen!2slk!4v1748255983048!5m2!1sen!2slk" 
                                        width="100%"
                                        height="200"
                                        style={{ border: 0 }}
                                        allowFullScreen=""
